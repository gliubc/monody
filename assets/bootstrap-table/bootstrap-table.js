    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        $.each(this.options.columns, function (i, columns) {
            ...
            $.each(columns, function (j, column) {
                ...
                if (column.minWidth !== undefined && (!that.options.cardView)) {
                    if (typeof column.minWidth === 'string') {
                        if (column.minWidth.indexOf('%') !== -1) {
                            unitMinWidth = '%';
                        }
                    }
                }
                ...
                if (column.minWidth && typeof column.minWidth === 'string') {
                    minWidth = column.minWidth.replace('%', '').replace('px', '');
                }
                ...
                style += sprintf('min-width: %s; ', (column.checkbox || column.radio) && !minWidth ?
                    '36px' : (minWidth ? minWidth + unitMinWidth : undefined));
